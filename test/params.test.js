...
describe('Capitalize String', () => {
  it('should Capitalized first letter of the string', () => {
    expect(clod.cap('only first letter or')).toBe('Only first letter or');
  });

  it('should Capitalized every word in the string', () => {
    expect(clod.cap('or every word', true)).toBe('Or Every Word');
  });
});
